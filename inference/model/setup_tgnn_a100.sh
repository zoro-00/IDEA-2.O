...
echo "Starting TGNN training on HI-Small on A100 GPU..."
...
python main.py --data Small_HI --model tgnn --tds --ports --ego --emlps --testing --batch_size 131072 --save_model --unique_name small_hi_tgnn_a100
